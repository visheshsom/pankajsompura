...
import DarkLogo from '../../assets/images/logo/300.png';
...
<div>
    ...
    <div className="header-top-area dark-area d-none d-lg-block">
        <div className="container">
            <div className="header-top__wrp">
                ...
                <ul className="header-top__links dark-area">
    ...
    <div className={`offcanvas ${isMobileMenuOpen ? 'open' : ''}`}> 
        ...
        <div className="offcanvas-body sidebar__body">
            ...
            <div className="d-none d-lg-block">
                <h5 className="text-black mb-20">About Us</h5>
            ...
            <div className="sidebar__contact-info mt-30">
                <h5 className="text-black mb-20">Contact Info</h5>
                <ul>
    ...
    <Link to="/" className="btn__mood-light"><i className="fa-light fa-sun-bright"></i></Link>
