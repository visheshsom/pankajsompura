...
import FooterLogo from '../../assets/images/logo/logo-light.png';
...
function FooterHomeFour({ className }) {
    return (
        <>
            <footer className={`footer-area bg-black ${className || ''}`}>
                ...
                <div className="container">
                    ...
                    <div className="footer__wrp-bottom black-border pt-60 pb-60">
