...
import logo1 from '../../assets/images/logo/logo-light.png';
// import DarkLogo from './assets/images/logo/logo-light.png';
import SidebarLogo from '../../assets/images/logo/logo-light.png';
...
<div>
    ...
    <header className="header-area header-four-area light-area">
        <div className="container">
            <div className="header-four__main">
                ...
                <button onClick={toggleMobileMenu} className="menubars d-inline-block d-lg-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#menubar">
                    <span></span>
                    <span></span>
                    <span></span>
                </button>
    ...
    <div className={`offcanvas ${isMobileMenuOpen ? 'open' : ''}`}> 
        ...
        <div className="offcanvas-body sidebar__body">
            ...
            <div className="d-none d-lg-block">
                ...
                <p className="sidebar__text">Unleash the full potential of your website and elevate its online presence with our comprehensive SEO solutions.</p>
            </div>
    ...
    <Link to="/index-4" className="btn__mood-light"><i className="fa-light fa-sun-bright"></i></Link>
