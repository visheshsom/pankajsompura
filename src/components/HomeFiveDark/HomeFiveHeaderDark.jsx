...
import DarkLogo from '../../assets/images/logo/45.png';
import SidebarLogo from '../../assets/images/logo/45.png';
...
<div>
    ...
    <header className="header-area header-five-area">
        <div className="header-five__main">
    ...
    <Link to="/index-5" className="btn__mood-light"><i className="fa-light fa-sun-bright"></i></Link>
