...
import ProjectShapeimage1 from '../../assets/images/shape/project-two-shape.png';
import ProjectShapeimage2 from '../../assets/images/shape/project-two-shape2.png';
...
return (
<>
        <section className={`project-two-area light-area pt-120 pb-120 ${className || ''}`}>
            <div className="project-two__shape">
                <img src={ProjectShapeimage1} alt="image"/>
            </div>
            <div className="project-two__shape-two">
                <img src={ProjectShapeimage2} alt="image"/>
            </div>
            <div className="container">
                <div className="project-two__wrp">
                    <div className="section-header text-center mb-50">
                        <h2 className="wow splt-txt text-white" data-splitting>Our Prominent Project</h2>
                    ...
                    <div className="row g-4 align-items-center">
                        <div className="col-lg-6">
                            <div className="project-two__item">
                                ...
                                <div className="project-two__content mt-25">
