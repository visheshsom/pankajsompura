...
import TeamImg1 from '../../assets/images/team/team-five-image1.png';
import TeamImg2 from '../../assets/images/team/team-five-image2.png';
import TeamImg3 from '../../assets/images/team/team-five-image3.png';
import TeamImg4 from '../../assets/images/team/team-five-image4.png';
import TeamImg5 from '../../assets/images/team/team-five-image5.png';
import TeamImg6 from '../../assets/images/team/team-five-image6.png';
import TeamImg7 from '../../assets/images/team/team-five-image7.png';
import TeamImg8 from '../../assets/images/team/team-five-image8.png';
                        ...
                        <div className="row g-4">
                            <div className="col-xl-3 col-sm-6">
                                <div className="team-five__item">
                                    ...
                                    <div className="content">
                                        <h3 className="mb-2"><Link className="primary-hover" to="/page-team-details">Wade Warren</Link></h3>
                                        <span>Designer</span>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-3 col-sm-6">
                                <div className="team-five__item">
                                    ...
                                    <div className="content">
                                        <h3 className="mb-2"><Link className="primary-hover" to="/page-team-details">Jenny Wilson</Link></h3>
                                        <span>Student</span>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-3 col-sm-6">
                                <div className="team-five__item">
                                    ...
                                    <div className="content">
                                        <h3 className="mb-2"><Link className="primary-hover" to="/page-team-details">Esther Howard</Link></h3>
                                        <span>HR Neuro</span>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-3 col-sm-6">
                                <div className="team-five__item">
                                    ...
                                    <div className="content">
                                        <h3 className="mb-2"><Link className="primary-hover" to="/page-team-details">Guy Hawkins</Link></h3>
                                        <span>CEO Neuro</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-xl-3 col-sm-6">
                                <div className="team-five__item">
                                    ...
                                    <div className="content">
                                        <h3 className="mb-2"><Link className="primary-hover" to="/page-team-details">Darrell Steward</Link></h3>
                                        <span>CEO Neuro</span>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-3 col-sm-6">
                                <div className="team-five__item">
                                    ...
                                    <div className="content">
                                        <h3 className="mb-2"><Link className="primary-hover" to="/page-team-details">Jerome Bell</Link></h3>
                                        <span>Designer</span>
                                    </div>
                                </div>
                            </div>
