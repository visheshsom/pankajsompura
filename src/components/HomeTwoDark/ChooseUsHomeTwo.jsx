...
function ChooseUsHomeTwo({ className }) {
    ...
    return (
        <>
        <section className={`choose-two-area dark-area pt-120 ${className || ""}`}>
            <div className="container">
                <div className="choose-two__wrp">
                    <div className="section-header text-center mb-50">
                        ...
                        <h2 className="wow splt-txt" data-splitting>Our skills are the primary <br /> reason clients choose us.</h2>
                    </div>
                    <div className="choose-two__image light-area">
