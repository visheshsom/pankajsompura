                    ...
                    <div className="col-lg-5">
                        <div className="funfact-four__left">
                            <div className="section-header">
                                ...
                                <Link to="/page-projects" className="btn-two mt-30 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">All Projects <i className="fa-light fa-arrow-up-right"></i></Link>
                            </div>
                        </div>
                    </div>
