...
return (
<>
        <section className={`plan-area ${className || ''}`} data-speed="0.5" data-parallax="scroll"
            ...
            <div className="plan__content pt-120 pb-120">
                <div className="section-header">
                    ...
                    <p className="wow fadeInUp text-white" data-wow-delay="200ms" data-wow-duration="1500ms">fusce accumsan tincidunt erat et convallis risus ullamcorper euoled <br /> vehicula massa a massa cursus</p>
                </div>
